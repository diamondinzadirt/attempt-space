  ...
  return (
    <MotionWrapper className='flex flex-col mt-2 lg:mt-10 xl:mt-20 items-center xl:flex-row'>
      <div className='flex flex-col text-center xl:text-left mx-auto my-0 xl:w-2/6 xl:ml-48 '>
          <h5 className='font-paragraph uppercase tracking-widest text-color-2 text-[1.75rem]'>Attempt Space</h5>
          <div className='uppercase font-Heading tracking-widest text-[5rem] mt-3 text-color-3 xl:text-[6.5rem]'>universe</div>
